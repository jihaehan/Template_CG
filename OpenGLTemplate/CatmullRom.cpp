...
void CCatmullRom::SetControlPoints()
{
	...
	m_controlPoints.push_back(glm::vec3(-400, 100, 0));			//7
	...
	m_controlUpVectors.push_back(glm::vec3(-1, 0, 1));	//3
	m_controlUpVectors.push_back(glm::vec3(-1, -1, 0));	//4
	m_controlUpVectors.push_back(glm::vec3(-1, 1, 0));	//5
	m_controlUpVectors.push_back(glm::vec3(0, 0, -1));	//62
