...
quat quaternion_util::RotationBetweenVectors(vec3 start, vec3 dest) {
...
quat quaternion_util::LookAt(vec3 direction, vec3 desiredUp) {
...
quat quaternion_util::RotateTowards(quat q1, quat q2, float maxAngle) {
